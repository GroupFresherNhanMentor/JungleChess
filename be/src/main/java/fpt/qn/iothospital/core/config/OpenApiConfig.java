package fpt.qn.iothospital.core.config;
...
public class OpenApiConfig {
    ...
    public GroupedOpenApi authApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("fpt.qn.iothospital.auth", "fpt.qn.iothospital.user")
                .build();
    }
    ...
    public GroupedOpenApi patientApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .pathsToMatch("/api/patients/**", "/api/admissions/**", "/api/departments/**",
                        "/api/rooms/**", "/api/beds/**")
                .packagesToScan("fpt.qn.iothospital.patient")
                .build();
    }
    ...
    public GroupedOpenApi medicineApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("fpt.qn.iothospital.medicine")
                .build();
    }
    ...
    public GroupedOpenApi appointmentApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("fpt.qn.iothospital.appointment")
                .build();
    }
    ...
    public GroupedOpenApi medicalRecordApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("fpt.qn.iothospital.medicalrecord")
                .build();
    }
    ...
    public GroupedOpenApi labApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("fpt.qn.iothospital.lab")
                .build();
    }
    ...
    public GroupedOpenApi alertApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("fpt.qn.iothospital.alert")
                .build();
    }
    ...
    public GroupedOpenApi billingApiGroup() {
        return GroupedOpenApi.builder()
                ...
                .packagesToScan("fpt.qn.iothospital.billing")
                .build();
    }
}
